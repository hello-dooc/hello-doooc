            ...
            <AllGoodsWrap>
                <div className="foodbox">
                    <div className="pets-title">
                        <span onClick={handleGotoOthers('/foodMarket')}>
                            一 &nbsp;<img src={img1} alt="" />
                            &nbsp;宠物食品 一
                        </span>
                        <p>Pet Food</p>
                ...
                <div className="commodilies">
                    <div className="pets-title">
                        <span onClick={handleGotoOthers('/daily')}>
                            一 &nbsp;<img src={img2} alt="" />
                            &nbsp;宠物日用品 一
                        </span>
                        <p>Pet Commodilies</p>
                ...
                <div className="marketbox">
                    <div className="pets-title">
                        <span onClick={handleGotoOthers('/petMarket')}>
                            一 &nbsp;<img src={img3} alt="" />
                            &nbsp;宠物市场 一
                        </span>
                        <p>Pet Market</p>
...
export default withRouter(AllGoods)