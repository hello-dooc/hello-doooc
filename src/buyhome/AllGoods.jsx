            ...
            <AllGoodsWrap>
                    ...
                    <div className="pet-food">
                        {
                            cate2 && cate2.map(value => {
                                return (
                                    <div className="img-box" key={value.id} onClick={this.handleFood(value.id)}>
                ...
                <div className="marketbox">
                    ...
                    <div className="pet-market">
                        {
                            cate3 && cate3.map(value => {
                                return (
                                    <div className="imgbox" key={value.petCatTableId}>
                                        <div className="topimg">
                                            <img src={value.petCatTableImage} alt="" />
                                        </div>
                                        <h1>{value.petCatTableCategory}</h1>
                                        <span>Click &gt;&gt;</span>
                                    </div>
                                )
                            })
